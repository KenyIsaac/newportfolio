      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row gap:0 md:gap-10">
        <div className="flex flex-col justify-center h-3/6 ">
          <h2 className="text-4xl sm:text-7xl font-bold text-white">
            Soy Desarollador 
            <TypeAnimation
            sequence={['Web FrontEnd', 1500, 'con énfasis en React.Js',1500]}
            repeat={Infinity}
            
             />
          </h2>
          <p className="text-gray-500 py-4 max-w-md">
          Desarrollador Web Front-End con énfasis en ReactJs | HTML 5 | CSS3 | JavaScript | Responsive Design | Git y Controlador de Versiones | AWS | Vercel | Netlify | Design Thinking | SCRUM | Metodologías ágiles
          </p>
